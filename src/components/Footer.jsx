...
const Footer = () => {
  return (
   ...
   <h3 className='text-center text-3xl mb-5 bg-gradient-to-r from-orange-500 to-red-500 text-transparent bg-clip-text font-bold italic'>By Muhammad Abbas...❤️</h3>
   </div>
   </footer>
  )
}
